...
![My Skills](https://skillicons.dev/icons?i=python,java,js,ts,html,css,react,nodejs,fastapi,spring,mysql,postgres,mongodb,pinecone,git,github,docker,linux,aws,azure,vscode,idea,pycharm,webstorm&perline=10)
